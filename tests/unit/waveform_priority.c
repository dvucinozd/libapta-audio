...
int main(void)
{
    ...
    int16_t background[1024];
    int16_t focused[1024];
    uint32_t accepted;
    uint32_t index;
    ...
    focus.playhead_frame = 4096u;
    focus.lookbehind_frames = 0u;
    focus.lookahead_frames = 1024u;
    ...
    CHECK(progress.consumed_input_frames == 1024u);
    ...
    CHECK(overview.spans[1].source_range.first_frame == 4096u);
    CHECK(overview.spans[1].source_range.end_frame == 5120u);
