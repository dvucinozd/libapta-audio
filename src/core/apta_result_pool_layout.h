...
typedef struct {
    ...
    size_t global_grid_state_offset;
    size_t global_grid_coverage_offset;
    size_t global_grid_segments_offset;
    ...
    uint32_t global_grid_coverage_capacity;
    uint32_t global_grid_segment_capacity;
