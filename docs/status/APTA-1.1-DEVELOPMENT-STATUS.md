...
| 8. Native musical key | Complete implementation / no promoted candidate | Bounded global major/minor analysis is complete. Harmonic projection was rejected at 22/96, centered correlation at 28/96 with 52 new high-confidence errors, and temporal chord-state voting at 38/96 with 24 fixes, six breaks and 36 new high-confidence errors. All three development splits are spent and the 48-track formal holdout remains unopened; see [`APTA-1.1-WP4-FMAK-TEMPORAL-CHORD-KEY-PROTOCOL.md`](APTA-1.1-WP4-FMAK-TEMPORAL-CHORD-KEY-PROTOCOL.md) |
