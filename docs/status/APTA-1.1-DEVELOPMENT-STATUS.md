...
| 8. Native musical key | Complete implementation / new WP4 candidate pre-registered | Bounded global major/minor analysis is complete. The harmonic projection was rejected at 22/96 on balanced GiantSteps-MTG development evidence. A separate resource-neutral centered-correlation candidate is now pre-registered against a new local 48-major/48-minor development split; no analyzer result has been inspected and the 48-track formal holdout remains unopened |
