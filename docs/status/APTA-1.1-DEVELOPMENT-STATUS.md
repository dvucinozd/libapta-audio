...
| 8. Native musical key | New development candidate pre-registered | Bounded global major/minor analysis is complete. Harmonic projection was rejected at 22/96, centered correlation at 28/96 with 52 new high-confidence errors, and temporal chord-state voting at 38/96 with 24 fixes, six breaks and 36 new high-confidence errors. A soft equal-window 24-profile aggregation candidate is frozen against a new class-balanced 96-track FMAK selection with zero overlap; its audio remains unopened and the 48-track formal holdout remains unopened; see [`APTA-1.1-WP4-FMAK-TEMPORAL-PROFILE-KEY-PROTOCOL.md`](APTA-1.1-WP4-FMAK-TEMPORAL-PROFILE-KEY-PROTOCOL.md) |
