...
| 8. Native musical key | Complete implementation / no promoted candidate | Bounded global major/minor analysis is complete. Harmonic projection was rejected at 22/96, centered correlation at 28/96 with 52 new high-confidence errors, temporal chord-state voting at 38/96 with 36 new high-confidence errors, and soft equal-window 24-profile aggregation at 17/96 versus production 18/96. All four development splits are spent and the 48-track formal holdout remains unopened; see [`APTA-1.1-WP4-FMAK-TEMPORAL-PROFILE-KEY-PROTOCOL.md`](APTA-1.1-WP4-FMAK-TEMPORAL-PROFILE-KEY-PROTOCOL.md) |
