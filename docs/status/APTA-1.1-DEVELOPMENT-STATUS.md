...
| 8. Native musical key | Complete implementation / development candidate | Bounded global major/minor analysis is complete. KP profiles plus log compression reach 20/60 on the spent human corpus; an opt-in verdict-gated -33/0/+33-cent experiment reaches 21/60 with zero breaks and zero high-confidence errors but remains disabled because the gain is too small for its 3x key CPU cost |
