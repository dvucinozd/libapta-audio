...
| 8. Native musical key | Complete implementation / development candidate | Bounded global major/minor analysis is complete. KP profiles plus log compression reach 20/60 on the spent human corpus; a low-cost opt-in harmonic projection reaches 22/60 with two fixes, zero breaks and zero high-confidence errors. It remains disabled pending independent key-development transfer evidence and a much larger absolute gain toward the 75% gate |
